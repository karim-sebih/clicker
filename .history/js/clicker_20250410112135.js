document.addEventListener('DOMContentLoaded', async function() {
    ...
    function loadUpgrades() {
        ...
        if (availableUpgrades.length === 0) {
            ...
            availableUpgrades.forEach((upgrade, index) => {
                ...
                // Ajouter l'événement clic avec addEventListener
    ...
    // Ajouter un gestionnaire d'événements au conteneur pour déboguer
    upgradeContainer.addEventListener('click', (e) => {
        console.log('Clic détecté sur upgradeContainer, cible:', e.target);
    });
