document.addEventListener('DOMContentLoaded', async function() {
    ...
    upgrades = upgrades.filter(upgrade => upgrade.owned === 0);

    // Initialisation de l'affichage
    ptsCont.textContent = `${Math.floor(pts)} Ressources`;
    cpsCont.textContent = `par seconde : ${Math.round(cps * 10) / 10}`;

    // Charger les améliorations (style inspiré de Cookie Clicker)
    if (upgrades.length === 0) {
        ...
        upgrades.forEach((upgrade, index) => {
            ...
            // Structure HTML inspirée de Cookie Clicker
            upgradeItem.innerHTML = `
                <div class="upgrade-content">
                    ...
                    <div class="upgrade-info">
                        ...
                        <span class="upgrade-cost-display">
                            <img src="../assets/resource-icon.png" alt="Ressource" class="resource-icon">
                            ${cost}
                        </span>
