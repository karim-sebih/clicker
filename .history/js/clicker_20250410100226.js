document.addEventListener('DOMContentLoaded', async function() {
    ...
    // Charger les améliorations (style : nom et coût en haut, icône, description en bas)
    if (upgrades.length === 0) {
        ...
        upgrades.forEach((upgrade, index) => {
            ...
            // Nouvelle structure HTML pour correspondre à l'image
            upgradeItem.innerHTML = `
                <div class="upgrade-content">
                    <div class="upgrade-header">
                        <span class="upgrade-name">${name} - ${cost} ressources</span>
                    </div>
