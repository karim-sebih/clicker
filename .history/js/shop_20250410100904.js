...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    if (!Array.isArray(shopData) || !Array.isArray(upgradeData)) {
        console.error('Les données chargées ne sont pas des tableaux valides.');
        return;
    }
    ...
    // Charger les améliorations (fusion de la logique de loadGameData)
    ...
    // Charger les bâtiments (fusion de la logique de loadGameData)
