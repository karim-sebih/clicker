...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    // Charger les améliorations (style similaire aux bâtiments, mais avec tooltip et disparition après achat)
    upgrades.forEach((upgrade, index) => {
        ...
        // Afficher uniquement l'icône par défaut (pas de "owned" car l'upgrade disparaît après achat)
