...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    // Réinitialiser les upgrades si nécessaire (pour éviter les données corrompues)
    if (upgrades.length === 0) {
        console.warn('Aucun upgrade trouvé dans upgradeData, rechargement depuis upgrade.json...');
        upgrades = await getUpgradeData();
